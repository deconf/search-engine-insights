...
use Exception;
use Deconf\SEIWP\Monolog\Formatter\LineFormatter;
 ...
 *
 *      $logger = new \Deconf\SEIWP\Monolog\Logger('all', array(new \Deconf\SEIWP\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('Deconf\\SEIWP\\Monolog\\'), // array Hide calls of classes started with...
