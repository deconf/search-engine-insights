...
namespace Deconf\SEIWP\Google\Auth;

use DateTime;
use Exception;
use Deconf\SEIWP\Firebase\JWT\ExpiredException;
use Deconf\SEIWP\Firebase\JWT\JWT;
...
use Deconf\SEIWP\GuzzleHttp\Psr7\Utils;
...
class AccessToken
{
    ...
    {
        $class = 'Deconf\SEIWP\Firebase\JWT\JWT';
