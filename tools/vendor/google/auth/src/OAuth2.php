...
use Deconf\SEIWP\GuzzleHttp\Psr7\Query;
...
class OAuth2 implements FetchAuthTokenInterface
{
     ...
     * @throws \Deconf\SEIWP\Firebase\JWT\SignatureInvalidException If the signature is invalid.
     * @throws \Deconf\SEIWP\Firebase\JWT\BeforeValidException If the token is not yet valid.
     * @throws \Deconf\SEIWP\Firebase\JWT\ExpiredException If the token has expired.
     * @return null|object
     */
