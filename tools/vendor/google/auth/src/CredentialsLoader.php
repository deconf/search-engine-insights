...
use Deconf\SEIWP\Google\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
    ...
    private static function getGuzzleMajorVersion()
    {
        ...
        if (defined('Deconf\SEIWP\GuzzleHttp\ClientInterface::VERSION')) {
     ...
     * @return \Deconf\SEIWP\GuzzleHttp\Client
     */
    public static function makeHttpClient(
        ...
        if (self::getGuzzleMajorVersion() === 5) {
            $client = new \Deconf\SEIWP\GuzzleHttp\Client($httpClientOptions);
        ...
        $stack = \Deconf\SEIWP\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \Deconf\SEIWP\GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
