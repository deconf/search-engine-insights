...
namespace Deconf\SEIWP\Google\AccessToken;

use DateTime;
use DomainException;
use Exception;
use ExpiredException;
use Deconf\SEIWP\Firebase\JWT\ExpiredException as ExpiredExceptionV3;
use Deconf\SEIWP\Firebase\JWT\Key;
use Deconf\SEIWP\Firebase\JWT\SignatureInvalidException;
use Deconf\SEIWP\Google\Auth\Cache\MemoryCacheItemPool;
use Deconf\SEIWP\Google\Exception as GoogleException;
...
class Verify
{
    ...
    /**
     * @var \Deconf\SEIWP\Firebase\JWT\JWT
    */
    public $jwt;
    ...
    {
        $jwtClass = 'JWT';
        if (class_exists('\Deconf\SEIWP\Firebase\JWT\JWT')) {
            $jwtClass = 'Deconf\SEIWP\Firebase\JWT\JWT';
        }
    ...
    private function getRsaClass()
    {
        ...
        if (class_exists('Deconf\SEIWP\phpseclib\Crypt\RSA')) {
    ...
    private function getBigIntClass()
    {
        ...
        if (class_exists('Deconf\SEIWP\phpseclib\Math\BigInteger')) {
    ...
    private function getOpenSslConstant()
    {
        ...
        if (class_exists('Deconf\SEIWP\phpseclib\Crypt\RSA')) {
            return 'Deconf\SEIWP\phpseclib\Crypt\RSA::MODE_OPENSSL';
        }
