...
use Deconf\SEIWP\Google\Http\MediaFileUpload;
use Deconf\SEIWP\Google\Model;
use Deconf\SEIWP\Google\Utils\UriTemplate;
...
class Resource
{
    ...
    /** @var \Deconf\SEIWP\Google\Client $client */
    private $client;
