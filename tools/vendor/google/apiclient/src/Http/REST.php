...
namespace Deconf\SEIWP\Google\Http;
...
use Deconf\SEIWP\Google\Task\Runner;
...
class REST
{
     ...
     * @return mixed|T|null
     * @throws \Deconf\SEIWP\Google\Service\Exception on server side error (ie: not authenticated,
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (
                interface_exists('\Deconf\SEIWP\GuzzleHttp\Message\ResponseInterface')
     ...
     * @param class-string<T>|false|null $expectedClass
     * @return mixed|T|null
     * @throws \Deconf\SEIWP\Google\Service\Exception
     */
