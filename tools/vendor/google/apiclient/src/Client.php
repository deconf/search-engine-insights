...
namespace Deconf\SEIWP\Google;

use BadMethodCallException;
use DomainException;
use Deconf\SEIWP\Google\AccessToken\Revoke;
use Deconf\SEIWP\Google\AccessToken\Verify;
use Deconf\SEIWP\Google\Auth\ApplicationDefaultCredentials;
use Deconf\SEIWP\Google\Auth\Cache\MemoryCacheItemPool;
use Deconf\SEIWP\Google\Auth\Credentials\ServiceAccountCredentials;
use Deconf\SEIWP\Google\Auth\Credentials\UserRefreshCredentials;
use Deconf\SEIWP\Google\Auth\CredentialsLoader;
use Deconf\SEIWP\Google\Auth\FetchAuthTokenCache;
use Deconf\SEIWP\Google\Auth\HttpHandler\HttpHandlerFactory;
use Deconf\SEIWP\Google\Auth\OAuth2;
use Deconf\SEIWP\Google\AuthHandler\AuthHandlerFactory;
use Deconf\SEIWP\Google\Http\REST;
use Deconf\SEIWP\GuzzleHttp\Client as GuzzleClient;
use Deconf\SEIWP\GuzzleHttp\ClientInterface;
use Deconf\SEIWP\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use Deconf\SEIWP\Monolog\Handler\StreamHandler as MonologStreamHandler;
use Deconf\SEIWP\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
class Client
{
     ...
     * @throws \Deconf\SEIWP\Google\Exception
    ...
    protected function createOAuth2Service()
    {
        $auth = new OAuth2([
            ...
            'tokenCredentialUri' => SEIWP_OAUTH2_TOKEN_URI,
    ...
    {
        $guzzleVersion = null;
        if (defined('\Deconf\SEIWP\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (defined('\Deconf\SEIWP\GuzzleHttp\ClientInterface::VERSION')) {
