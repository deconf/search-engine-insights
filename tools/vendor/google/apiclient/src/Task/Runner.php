...
namespace Deconf\SEIWP\Google\Task;

use Deconf\SEIWP\Google\Service\Exception as GoogleServiceException;
use Deconf\SEIWP\Google\Task\Exception as GoogleTaskException;
...
class Runner
{
     ...
     * @throws \Deconf\SEIWP\Google\Task\Exception when misconfigured
     */
     ...
     *
     * @return mixed
     * @throws \Deconf\SEIWP\Google\Service\Exception on failure when no retries are available.
     */
    public function run()
    {
        while ($this->attempt()) {
