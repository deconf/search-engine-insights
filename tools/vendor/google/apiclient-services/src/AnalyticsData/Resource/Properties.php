...
namespace Deconf\SEIWP\Google\Service\AnalyticsData\Resource;

use Deconf\SEIWP\Google\Service\AnalyticsData\BatchRunPivotReportsRequest;
use Deconf\SEIWP\Google\Service\AnalyticsData\BatchRunPivotReportsResponse;
use Deconf\SEIWP\Google\Service\AnalyticsData\BatchRunReportsRequest;
use Deconf\SEIWP\Google\Service\AnalyticsData\BatchRunReportsResponse;
use Deconf\SEIWP\Google\Service\AnalyticsData\CheckCompatibilityRequest;
use Deconf\SEIWP\Google\Service\AnalyticsData\CheckCompatibilityResponse;
use Deconf\SEIWP\Google\Service\AnalyticsData\Metadata;
use Deconf\SEIWP\Google\Service\AnalyticsData\RunPivotReportRequest;
use Deconf\SEIWP\Google\Service\AnalyticsData\RunPivotReportResponse;
use Deconf\SEIWP\Google\Service\AnalyticsData\RunRealtimeReportRequest;
use Deconf\SEIWP\Google\Service\AnalyticsData\RunRealtimeReportResponse;
use Deconf\SEIWP\Google\Service\AnalyticsData\RunReportRequest;
use Deconf\SEIWP\Google\Service\AnalyticsData\RunReportResponse;

/**
 * The "properties" collection of methods.
 * Typical usage is:
 *  <code>
 *   $analyticsdataService = new Deconf\SEIWP\Google\Service\AnalyticsData(...);
 *   $properties = $analyticsdataService->properties;
 *  </code>
 */
class Properties extends \Deconf\SEIWP\Google\Service\Resource
{
  /**
