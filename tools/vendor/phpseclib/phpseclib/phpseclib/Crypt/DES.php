 ...
 *
 *    $des = new \Deconf\SEIWP\phpseclib\Crypt\DES();
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends Base
{
     ...
     * @see \Deconf\SEIWP\phpseclib\Crypt\DES::_processBlock()
     */
    /**
     ...
     *
     * @see \Deconf\SEIWP\phpseclib\Crypt\Base::block_size
     * @var int
     * @access private
     */
    var $block_size = 8;
     ...
     *
     * @see \Deconf\SEIWP\phpseclib\Crypt\Base::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \Deconf\SEIWP\phpseclib\Crypt\Base::isValidEngine()
     * @param int $engine
     * @access public
     * @return bool
     */
     ...
     * Encrypts a block
     *
     * @see \Deconf\SEIWP\phpseclib\Crypt\Base::_encryptBlock()
     ...
     * Decrypts a block
     *
     * @see \Deconf\SEIWP\phpseclib\Crypt\Base::_decryptBlock()
     ...
     *
     * @see \Deconf\SEIWP\phpseclib\Crypt\Base::_setupInlineCrypt()
     * @access private
     */
