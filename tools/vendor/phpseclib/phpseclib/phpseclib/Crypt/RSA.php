 ...
 *
 *    $rsa = new \Deconf\SEIWP\phpseclib\Crypt\RSA();
...
class RSA
{
    ...
    */
    ...
    /**#@+
     * @access private
     * @see \Deconf\SEIWP\phpseclib\Crypt\RSA::createKey()
    */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \Deconf\SEIWP\phpseclib\Crypt\RSA::__construct()
    */
    /**
     ...
     * @access public
     * @see \Deconf\SEIWP\phpseclib\Crypt\RSA::createKey()
     * @see \Deconf\SEIWP\phpseclib\Crypt\RSA::setPrivateKeyFormat()
    */
    /**
     ...
     * @access public
     * @see \Deconf\SEIWP\phpseclib\Crypt\RSA::createKey()
     * @see \Deconf\SEIWP\phpseclib\Crypt\RSA::setPublicKeyFormat()
    */
    /**
     * Raw public key
     *
     ...
     * Precomputed Zero
     *
     * @var \Deconf\SEIWP\phpseclib\Math\BigInteger
     * @access private
     */
    var $zero;
     ...
     * Hash function
     *
     * @var \Deconf\SEIWP\phpseclib\Crypt\Hash
     * @access private
     */
    var $hash;
     ...
     *
     * @return \Deconf\SEIWP\phpseclib\Crypt\RSA
     * @access public
     */
     ...
     * @access private
     * @param \Deconf\SEIWP\phpseclib\Math\BigInteger $x
     * @param \Deconf\SEIWP\phpseclib\Math\BigInteger $r
     * @param int $i
     * @return \Deconf\SEIWP\phpseclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \Deconf\SEIWP\phpseclib\Math\BigInteger $m
     * @return \Deconf\SEIWP\phpseclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \Deconf\SEIWP\phpseclib\Math\BigInteger $c
     * @return \Deconf\SEIWP\phpseclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \Deconf\SEIWP\phpseclib\Math\BigInteger $s
     * @return \Deconf\SEIWP\phpseclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
