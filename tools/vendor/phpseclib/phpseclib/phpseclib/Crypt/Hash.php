 ...
 *
 *    $hash = new \Deconf\SEIWP\phpseclib\Crypt\Hash('sha1');
 *
 *    $hash->setKey('abcdefg');
 *
...
class Hash
{
    /**#@+
     * @access private
     * @see \Deconf\SEIWP\phpseclib\Crypt\Hash::__construct()
     */
    /**
     ...
     *
     * @param string $hash
     * @return \Deconf\SEIWP\phpseclib\Crypt\Hash
     * @access public
     */
    ...
    function _sha512($m)
    {
        ...
        // Produce the final hash value (big-endian)
        // (\Deconf\SEIWP\phpseclib\Crypt\Hash::hash() trims the output for hashes but not for HMACs.  as such, we trim the output here)
