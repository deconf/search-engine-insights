 ...
 *
 *    $ssh = new \Deconf\SEIWP\phpseclib\Net\SSH1('www.domain.tld');
...
use Deconf\SEIWP\phpseclib\Crypt\DES;
...
class SSH1
{
     ...
     * Encryption Methods
     *
     * @see \Deconf\SEIWP\phpseclib\Net\SSH1::getSupportedCiphers()
     * @access public
     */
    /**
     * No encryption
     ...
     *
     * @see \Deconf\SEIWP\phpseclib\Net\SSH1::getSupportedAuthentications()
     * @access public
    */
    /**
    ...
    */
     ...
     * The Response Type
     *
     * @see \Deconf\SEIWP\phpseclib\Net\SSH1::_get_binary_packet()
     * @access private
     */
     ...
     *
     * @see \Deconf\SEIWP\phpseclib\Net\SSH1::bitmap
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \Deconf\SEIWP\phpseclib\Net\SSH1::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \Deconf\SEIWP\phpseclib\Net\SSH1::read()
    */
    /**
     ...
     * @param int $timeout
     * @param int $cipher
     * @return \Deconf\SEIWP\phpseclib\Net\SSH1
     * @access public
     */
    ...
    function _connect()
    {
        ...
        switch ($cipher) {
            ...
            //    $this->crypto = new \Deconf\SEIWP\phpseclib\Crypt\Null();
            //    break;
     ...
     *
     * To execute further commands, a new \Deconf\SEIWP\phpseclib\Net\SSH1 object will need to be created.
     *
    ...
    function exec($cmd, $block = true)
    {
        ...
        // reset the execution bitmap - a new \Deconf\SEIWP\phpseclib\Net\SSH1 object needs to be created.
        $this->bitmap = 0;
