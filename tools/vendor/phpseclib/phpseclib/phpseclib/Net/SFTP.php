 ...
 *
 *    $sftp = new \Deconf\SEIWP\phpseclib\Net\SFTP('www.domain.tld');
...
class SFTP extends SSH2
{
    ...
    /**#@+
     * @access public
     * @see \Deconf\SEIWP\phpseclib\Net\SFTP::put()
    */
    /**
     ...
     * @param int $port
     * @param int $timeout
     * @return \Deconf\SEIWP\phpseclib\Net\SFTP
     * @access public
     */
     ...
     *
     * By default, \Deconf\SEIWP\phpseclib\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
