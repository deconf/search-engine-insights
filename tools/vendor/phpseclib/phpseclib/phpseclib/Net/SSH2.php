 ...
 *
 *    $ssh = new \Deconf\SEIWP\phpseclib\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = new \Deconf\SEIWP\phpseclib\Crypt\RSA();
...
namespace Deconf\SEIWP\phpseclib\Net;

use Deconf\SEIWP\phpseclib\Crypt\Base;
use Deconf\SEIWP\phpseclib\Crypt\Blowfish;
use Deconf\SEIWP\phpseclib\Crypt\Hash;
use Deconf\SEIWP\phpseclib\Crypt\Random;
use Deconf\SEIWP\phpseclib\Crypt\RC4;
use Deconf\SEIWP\phpseclib\Crypt\Rijndael;
use Deconf\SEIWP\phpseclib\Crypt\RSA;
use Deconf\SEIWP\phpseclib\Crypt\TripleDES;
use Deconf\SEIWP\phpseclib\Crypt\Twofish;
use Deconf\SEIWP\phpseclib\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Deconf\SEIWP\phpseclib\System\SSH\Agent;
...
class SSH2
{
     ...
     *
     * @see \Deconf\SEIWP\phpseclib\Net\SSH2::bitmap
     * @access private
     */
     ...
     *     the other side.
     *
     * @see \Deconf\SEIWP\phpseclib\Net\SSH2::_send_channel_packet()
     * @see \Deconf\SEIWP\phpseclib\Net\SSH2::_get_channel_packet()
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \Deconf\SEIWP\phpseclib\Net\SSH2::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \Deconf\SEIWP\phpseclib\Net\SSH2::read()
    */
    /**
     ...
     * @param int $timeout
     * @see self::login()
     * @return \Deconf\SEIWP\phpseclib\Net\SSH2
     * @access public
     */
     ...
     *
     * @param string $username
     * @param \Deconf\SEIWP\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \Deconf\SEIWP\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
