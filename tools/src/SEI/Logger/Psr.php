 ...
 * with the `SEI_Logger_Psr::setLogger()` method.
 */
class SEI_Logger_Psr extends SEI_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(SEI_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
