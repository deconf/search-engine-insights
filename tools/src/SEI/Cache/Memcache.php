 ...
 */
class SEI_Cache_Memcache extends SEI_Cache_Abstract
{
  ...
  public function __construct(SEI_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new SEI_Cache_Exception($error);
    }
  ...
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new SEI_Cache_Exception("Couldn't store data in cache");
    }
