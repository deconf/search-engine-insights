 ...
 * @author Google, Inc.
 */
class SEI_Service_Webmasters extends SEI_Service
{
   ...
   *
   * @param SEI_Client $client
   */
  public function __construct(SEI_Client $client)
  {
    ...
    $this->searchanalytics = new SEI_Service_Webmasters_Searchanalytics_Resource(
        $this,
        $this->serviceName,
        'searchanalytics',
        array(
    ...
    $this->sitemaps = new SEI_Service_Webmasters_Sitemaps_Resource(
        $this,
        $this->serviceName,
        'sitemaps',
        array(
    ...
    $this->sites = new SEI_Service_Webmasters_Sites_Resource(
        $this,
        $this->serviceName,
        'sites',
        array(
    ...
    $this->urlcrawlerrorscounts = new SEI_Service_Webmasters_Urlcrawlerrorscounts_Resource(
        $this,
        $this->serviceName,
    ...
    $this->urlcrawlerrorssamples = new SEI_Service_Webmasters_Urlcrawlerrorssamples_Resource(
        $this,
        $this->serviceName,
 ...
 * Typical usage is:
 *  <code>
 *   $webmastersService = new SEI_Service_Webmasters(...);
 *   $searchanalytics = $webmastersService->searchanalytics;
 *  </code>
 */
class SEI_Service_Webmasters_Searchanalytics_Resource extends SEI_Service_Resource
{
   ...
   * @param SEI_SearchAnalyticsQueryRequest $postBody
   * @param array $optParams Optional parameters.
   * @return SEI_Service_Webmasters_SearchAnalyticsQueryResponse
   */
  public function query($siteUrl, SEI_Service_Webmasters_SearchAnalyticsQueryRequest $postBody, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "SEI_Service_Webmasters_SearchAnalyticsQueryResponse");
  }
}
 ...
 *  </code>
 */
class SEI_Service_Webmasters_Sitemaps_Resource extends SEI_Service_Resource
{
   ...
   * http://www.example.com/sitemap.xml
   * @param array $optParams Optional parameters.
   * @return SEI_Service_Webmasters_WmxSitemap
   */
  public function get($siteUrl, $feedpath, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'feedpath' => $feedpath);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SEI_Service_Webmasters_WmxSitemap");
  }
   ...
   * @return SEI_Service_Webmasters_SitemapsListResponse
   */
  public function listSitemaps($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SEI_Service_Webmasters_SitemapsListResponse");
  }
 ...
 *  </code>
 */
class SEI_Service_Webmasters_Sites_Resource extends SEI_Service_Resource
{
   ...
   * Examples: http://www.example.com/ or android-app://com.example/
   * @param array $optParams Optional parameters.
   * @return SEI_Service_Webmasters_WmxSite
   */
  public function get($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SEI_Service_Webmasters_WmxSite");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return SEI_Service_Webmasters_SitesListResponse
   */
  public function listSites($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SEI_Service_Webmasters_SitesListResponse");
  }
}
 ...
 *  </code>
 */
class SEI_Service_Webmasters_Urlcrawlerrorscounts_Resource extends SEI_Service_Resource
{
   ...
   * platforms.
   * @return SEI_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse
   */
  public function query($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "SEI_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse");
  }
}
 ...
 *  </code>
 */
class SEI_Service_Webmasters_Urlcrawlerrorssamples_Resource extends SEI_Service_Resource
{
   ...
   * For example: web
   * @param array $optParams Optional parameters.
   * @return SEI_Service_Webmasters_UrlCrawlErrorsSample
   */
  public function get($siteUrl, $url, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "SEI_Service_Webmasters_UrlCrawlErrorsSample");
  }
   ...
   * For example: web
   * @param array $optParams Optional parameters.
   * @return SEI_Service_Webmasters_UrlCrawlErrorsSamplesListResponse
   */
  public function listUrlcrawlerrorssamples($siteUrl, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "SEI_Service_Webmasters_UrlCrawlErrorsSamplesListResponse");
  }
...
class SEI_Service_Webmasters_ApiDataRow extends SEI_Collection
{
...
class SEI_Service_Webmasters_ApiDimensionFilter extends SEI_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $dimension;
...
class SEI_Service_Webmasters_ApiDimensionFilterGroup extends SEI_Collection
{
  protected $collection_key = 'filters';
  protected $internal_gapi_mappings = array(
  );
  protected $filtersType = 'SEI_Service_Webmasters_ApiDimensionFilter';
...
class SEI_Service_Webmasters_SearchAnalyticsQueryRequest extends SEI_Collection
{
  protected $collection_key = 'dimensions';
  protected $internal_gapi_mappings = array(
  );
  public $aggregationType;
  protected $dimensionFilterGroupsType = 'SEI_Service_Webmasters_ApiDimensionFilterGroup';
...
class SEI_Service_Webmasters_SearchAnalyticsQueryResponse extends SEI_Collection
{
  protected $collection_key = 'rows';
  protected $internal_gapi_mappings = array(
  );
  public $responseAggregationType;
  protected $rowsType = 'SEI_Service_Webmasters_ApiDataRow';
...
class SEI_Service_Webmasters_SitemapsListResponse extends SEI_Collection
{
  protected $collection_key = 'sitemap';
  protected $internal_gapi_mappings = array(
  );
  protected $sitemapType = 'SEI_Service_Webmasters_WmxSitemap';
...
class SEI_Service_Webmasters_SitesListResponse extends SEI_Collection
{
  protected $collection_key = 'siteEntry';
  protected $internal_gapi_mappings = array(
  );
  protected $siteEntryType = 'SEI_Service_Webmasters_WmxSite';
...
class SEI_Service_Webmasters_UrlCrawlErrorCount extends SEI_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class SEI_Service_Webmasters_UrlCrawlErrorCountsPerType extends SEI_Collection
{
  protected $collection_key = 'entries';
  protected $internal_gapi_mappings = array(
  );
  public $category;
  protected $entriesType = 'SEI_Service_Webmasters_UrlCrawlErrorCount';
...
class SEI_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse extends SEI_Collection
{
  protected $collection_key = 'countPerTypes';
  protected $internal_gapi_mappings = array(
  );
  protected $countPerTypesType = 'SEI_Service_Webmasters_UrlCrawlErrorCountsPerType';
...
class SEI_Service_Webmasters_UrlCrawlErrorsSample extends SEI_Model
{
  protected $internal_gapi_mappings = array(
  ...
  public $pageUrl;
  public $responseCode;
  protected $urlDetailsType = 'SEI_Service_Webmasters_UrlSampleDetails';
  ...
  public function setUrlDetails(SEI_Service_Webmasters_UrlSampleDetails $urlDetails)
  {
...
class SEI_Service_Webmasters_UrlCrawlErrorsSamplesListResponse extends SEI_Collection
{
  protected $collection_key = 'urlCrawlErrorSample';
  protected $internal_gapi_mappings = array(
  );
  protected $urlCrawlErrorSampleType = 'SEI_Service_Webmasters_UrlCrawlErrorsSample';
...
class SEI_Service_Webmasters_UrlSampleDetails extends SEI_Collection
{
...
class SEI_Service_Webmasters_WmxSite extends SEI_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class SEI_Service_Webmasters_WmxSitemap extends SEI_Collection
{
  protected $collection_key = 'contents';
  protected $internal_gapi_mappings = array(
  );
  protected $contentsType = 'SEI_Service_Webmasters_WmxSitemapContent';
...
class SEI_Service_Webmasters_WmxSitemapContent extends SEI_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $indexed;
