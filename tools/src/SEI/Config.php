...
class SEI_Config
{
  ...
  /**
   * Create a new SEI_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'SEI_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'SEI_Cache_File',
      'logger_class'  => 'SEI_Logger_Null',
      ...
      'classes' => array(
        ...
        'SEI_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'SEI_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'SEI_Http_Request' => array(
        ...
        'SEI_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/SEI_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see SEI_Auth_LoginTicket) after sign
