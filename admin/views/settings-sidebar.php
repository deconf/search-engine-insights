		...
		<div class="postbox">
			...
			<div class="inside">
				...
				<div class="seiwp-desc">
							<?php printf(__('%s - A cookieless web analytics service for website tracking.', 'search-engine-insights'), sprintf('<a href="https://deconf.com/clicky-web-analytics-review/?utm_source=aiwp_config&utm_medium=link&utm_content=clicky&utm_campaign=aiwp">%s</a>', __('Clicky Analytics', 'search-engine-insights')));?>
						</div>
				<br />
				<div class="seiwp-title">
